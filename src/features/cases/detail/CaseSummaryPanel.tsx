...
export function CaseSummaryPanel({ caseData }: CaseSummaryPanelProps) {
  ...
  return (
    <aside className={styles.panel}>
      {primaryDoc ? (
        <PdfPreview caseId={caseData.caseId} document={primaryDoc} />
      ) : (
        <div className={styles.pdfPreview}>
          <div className={styles.pdfPlaceholder} aria-label="No PDF uploaded">
            <svg
            ...
            <p className={styles.pdfLabel}>No PDF uploaded</p>
          </div>
        </div>
      )}
